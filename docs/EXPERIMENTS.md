...
**Colin's approach inside our engine (three pre-declared one-shots, report only):** his ingredients in our stack with fold-fitted weights 36.6 / 42.5; his model layer (CatBoost plus TabICL, equal blend, every block on, window 2003) 34.8 / 39.5; his exact CatBoost settings (800 trees, depth 5, learning rate 0.03, nine seeds) on his feature families: pending at the time of writing. The rank-average of our verified-equivalent board with his baseline board is being scored for the record.
