...
**Also verified and not adopted:** island B's accepted mutation (trajectory + Torvik own-line blocks, +0.046 on folds with 7 of 7) scored 42.5 / 38.6 blind. Ridge-based block members changed nothing for any block (−0.005 to +0.001). The islands were reseeded from the new champion.
