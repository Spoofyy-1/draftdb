...
PREFIX = {
    ...
    "srcflag": "src_",
    "conf_split": "tcf_",
    "language": "li_",  # BRIDGE: dated interview-transcript language rates (ASAP Sports archive, rule-based dictionaries)  # BRIDGE: Torvik conference-only line and deltas versus the full season
