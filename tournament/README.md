...
| Six extra members on the final feature set (TabLDM 0.484, XGB 0.481, LGBM 0.473, TabICL-2003 0.455, TabICL classifier 0.448, ridge 0.440) | 6-way blend 0.5065 (+0.003, noise); 10-way blend 0.495; 10-member context-fit stack 0.496 -- the context years favour members that do worse on holdout |
